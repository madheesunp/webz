...
export type FieldOutputTypes = {
  readonly public: {
    readonly Comment: {
      ...
      readonly webId: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly Comment: {
      ...
      readonly webId: CodecTypes['pg/text@1']['input'];
          ...
          readonly table: {
            readonly comment: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'comment_webId_idx_c42eba5e';
                  readonly prefix: 'comment_webId_idx';
                  readonly columns: readonly ['webId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly like: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['userId', 'webId'] }];
              indexes: readonly [
                {
                ...
                {
                  readonly name: 'like_webId_idx_c42eba5e';
                  readonly prefix: 'like_webId_idx';
                  readonly columns: readonly ['webId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly web: {
              ...
              indexes: readonly [
                {
                  readonly name: 'web_authorId_idx_e47547ed';
                  readonly prefix: 'web_authorId_idx';
                  readonly columns: readonly ['authorId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'web_public_idx_f6eb82a8';
                  readonly prefix: 'web_public_idx';
                  readonly columns: readonly ['public'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
...
> & {
  ...
  readonly roots: {
    ...
    readonly web: { readonly namespace: 'public' & NamespaceId; readonly model: 'Web' };
        ...
        readonly models: {
          readonly Comment: {
            ...
            readonly relations: {
              ...
              readonly web: {
                readonly to: { readonly namespace: 'public' & NamespaceId; readonly model: 'Web' };
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['webId'];
                  readonly targetFields: readonly ['id'];
                };
              };
            };
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly webId: { readonly column: 'webId' };
          ...
          readonly Web: {
            ...
            readonly relations: {
              ...
              readonly comments: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['webId'];
                };
              };
              readonly likes: {
                readonly to: { readonly namespace: 'public' & NamespaceId; readonly model: 'Like' };
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly authorId: { readonly column: 'authorId' };
                readonly nodes: { readonly column: 'nodes' };
                readonly edges: { readonly column: 'edges' };
